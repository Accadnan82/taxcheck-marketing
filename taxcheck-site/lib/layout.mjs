...
export const ROUTES = ['home', 'product', 'ai', 'corporate-tax', 'vat', 'review', 'dashboard', 'accountants', 'businesses', 'services', 'einvoicing', 'penalty-calculator', 'pricing', 'demo', 'resources', 'security', 'about', 'contact', 'careers', 'privacy', 'terms', 'refund', 'disclaimer'];
